          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="border-2 border-primary/20 hover:border-primary/40 transition-colors">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Принимаем работы до 31 декабря. Победители будут определены с помощью рандомайзера
                  </p>
                </CardContent>
              </Card>
              <Card className="border-2 border-primary/20 hover:border-primary/40 transition-colors">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Участвовать могут все желающие без ограничений по возрасту. Можно отправить несколько рисунков
                  </p>
                </CardContent>
              </Card>
              <Card className="border-2 border-primary/20 hover:border-primary/40 transition-colors">
